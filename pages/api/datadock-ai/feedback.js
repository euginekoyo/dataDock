...
export default async function feedback(req, res) {
  ...
  switch (req.method) {
    ...
    case 'POST':
      ...
      `;
      let csvresp = await getOpenRouterResponse(csvPrompt, 100, 0, 0);
